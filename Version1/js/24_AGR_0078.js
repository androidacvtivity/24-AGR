...
function validate33_001_F(values) {
    ...
    for (var j = 1; j <= values.CAP_NUM_FILIAL.length; j++) {
        ...
        if ((CAP1_R5_C1_FILIAL !== result_33_001_F)) {
                webform.errors.push({
                    'fieldName': 'CAP1_R5_C1_FILIAL',
                    'index': j,
                    'weight': 19,
                    'msg': Drupal.t('Raion: @CAP_CUATM_FILIAL - Cod eroare: 33-001-F. [@col_FILIAL] - Cap.II pe COL(@col_FILIAL), Rînd.(210) COL(1,3,4,5,6,8) = Rînd.(1+2-4) COL(1,3,4,5,6,8), @R5_C <> @result_33_001_F ', { '@CAP_CUATM_FILIAL': CAP_CUATM_FILIAL, '@col_FILIAL': j, '@R5_C': CAP1_R5_C1_FILIAL, '@result_33_001_F': result_33_001_F })
                });
            }
        }
