            ...
            if (i !== 2) {
                ...
                if ((R10_C1 !== 0 && R8_C === 0)  ) {
                    webform.errors.push({
                        ...
                        'index': j,
                        'weight': 19,
                        'msg': Drupal.t('Raion: @CAP_CUATM_FILIAL - Cod eroare: 33-008-F. [@col_FILIAL] - COL(@col_FILIAL), Dacă Rînd.(10) COL(1) ≠ 0 atunci Rînd.(10) COL(1) ≠ 0, @R10_C1 <> @R8_C', { '@CAP_CUATM_FILIAL': CAP_CUATM_FILIAL, '@col_FILIAL': i, '@R10_C1': R10_C1, '@R8_C': R8_C })
                    });
                }
            }
        }
