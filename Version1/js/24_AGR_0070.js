...
webform.validators.agro24 = function (v, allowOverpass) {
    ...
    //Create function of the 33-001
    //Tab.1.1, rd.5 COL(1,3,4,5,6,8) = Tab1.1 rd.(1+2-4) COL(1,3,4,5,6,8)

    // //Start 33-001
    // for (var i = 1; i <= 8; i++) {
       
    //     if (i !== 2 && i !== 7) {
    //     if (!isNaN(Number(values["CAP1_R5_C" + i]))) {
    //         var CAP1_R5_C = 0;
    //         CAP1_R5_C = Number(values["CAP1_R5_C" + i]);
    //     }
        
    //     if (!isNaN(Number(values["CAP1_R1_C" + i]))) {
    //         var CAP1_R1_C = 0;
    //         CAP1_R1_C = Number(values["CAP1_R1_C" + i]);
    //     }

    //     if (!isNaN(Number(values["CAP1_R2_C" + i]))) {
    //         var CAP1_R2_C = 0;
    //         CAP1_R2_C = Number(values["CAP1_R2_C" + i]);
    //     }

    //     if (!isNaN(Number(values["CAP1_R4_C" + i]))) {
    //         var CAP1_R4_C = 0;
    //         CAP1_R4_C = Number(values["CAP1_R4_C" + i]);
    //     }
     
    //     var result_33_001 = 0;
    //     result_33_001 = CAP1_R1_C + CAP1_R2_C - CAP1_R4_C;
