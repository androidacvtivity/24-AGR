        ...
        if (i !== 20) {
            ...
            if (CAP11_R8_C !== 0 && CAP12_R7_C === 0) {
                webform.warnings.push({
                    ...
                    'weight': 19,
                    'index': i,
                    'msg': Drupal.t('Cod eroare: 33-005. [@col] - Dacă Tab.1.1.1, rd.8 pe COL (@col), COL(1) ≠ 0 atunci Tab 1.2 Rînd.(7) COL(1) ≠ 0 și invers , @CAP11_R8_C - @CAP12_R7_C ≠ 0', { '@col': i, '@CAP11_R8_C': CAP11_R8_C, '@CAP12_R7_C': CAP12_R7_C })
                });
            } 
        ...
        if (i !== 20) {
            ...
            if (CAP11_R9_C !== 0 && CAP12_R8_C === 0) {
                webform.warnings.push({
                    ...
                    'weight': 19,
                    'index': i,
                    'msg': Drupal.t('Cod eroare: 33-006. [@col] - Tab.1.1.1, Dacă rd.9 pe COL (@col), COL(1) ≠ 0 atunci Tab 1.2 Rînd.(8) COL(1) ≠ 0 și invers , @CAP11_R9_C - @CAP12_R8_C ≠ 0', { '@col': i, '@CAP11_R9_C': CAP11_R9_C, '@CAP12_R8_C': CAP12_R8_C })
                });
            } 
            ...
            if (i !== 20) {
                    ...
                    
                {
                    webform.warnings.push({
                        ...
                        'index': j,
                        'weight': 19,
                        'msg': Drupal.t('Raion: @CAP_CUATM_FILIAL - Cod eroare: 33-006-F. [@col_FILIAL] - COL(@col_FILIAL), Dacă Rînd.(9) COL(1) ≠ 0 atunci Rînd.(8) COL(1) ≠ 0 si invers, @R9_C <> @R8_C', { '@CAP_CUATM_FILIAL': CAP_CUATM_FILIAL, '@col_FILIAL': i, '@R9_C': R9_C, '@R8_C': R8_C })
                    });
                }
            }
        }
