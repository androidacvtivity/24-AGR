        ...
        if (i !== 20) {
            ...
            if (CAP11_R7_C !== 0 && CAP12_R3_C === 0) {
                webform.errors.push({
                    ...
                    'weight': 19,
                    'index': i,
                    'msg': Drupal.t('Cod eroare: 33-003. [@col] - Tab.1.1.1, rd.7 pe COL (@col), COL(1) ≠ 0 atunci Tab 1.2 Rînd.(3) COL(1) ≠ 0 și invers , @CAP11_R7_C - @CAP1_R3_C ≠ 0', { '@col': i, '@CAP11_R7_C': CAP11_R7_C, '@CAP1_R3_C': CAP1_R3_C })
                });
