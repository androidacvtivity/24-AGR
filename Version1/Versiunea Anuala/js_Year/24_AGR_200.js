    ...
    Drupal.behaviors.agro24 = {
        attach: function (context, settings) {
            ...
            function toggleCap12(trimValue) {
                ...
                if (trimValue == 4) {
                    // Ascunde capitolul 1.2 și rândurile aferente
                    ...
                    // Afișează din nou capitolul 1.2 și rândurile aferente
...
// 
            // Funcție pentru manipularea capitolului dinamic
            // function toggleDynamicCap12(trimValue) {
            //     var headerElement = jQuery('#header-1-2');
            ...
            function toggleDynamicCap12(trimValue) {
                ...
                if (trimValue == 4) {
                    // Ascunde și modifică textul, dacă e necesar
                    headerElement.hide();
                    headerElement.text("Capitolul este ascuns deoarece TRIM este 4");
                } else {
                    // Afișează și modifică textul înapoi la cel original
                    headerElement.show();
                    headerElement.text("1.2 EFECTIVELE DE ANIMALE EXISTENTE LA SFÂRȘITUL PERIOADEI DE RAPORT");
                }
            }
