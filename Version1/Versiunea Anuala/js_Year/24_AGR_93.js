        ...
        attach: function (context, settings) {
            ...
            function toggleCap2(trimValue) {
                    ...
                    if (trimValue === 4) {
                        ...
                        jQuery('input[name^="CAP12"]').val('');            // How is more clear or good Like this 

                        document.getElementById("CAP12_R1_C1").value = "";
                        document.getElementById("CAP12_R2_C1").value = "";
                        document.getElementById("CAP12_R3_C1").value = "";
                        document.getElementById("CAP12_R4_C1").value = "";
                        document.getElementById("CAP12_R5_C1").value = "";
                        document.getElementById("CAP12_R6_C1").value = "";
                        document.getElementById("CAP12_R7_C1").value = ""; //How is more clear or good Like this 
                        document.getElementById("CAP12_R8_C1").value = "";
                        document.getElementById("CAP12_R9_C1").value = "";
                        document.getElementById("CAP12_R10_C1").value = "";
                        document.getElementById("CAP12_R11_C1").value = "";


                    } else 
                    
                        if (trimValue === 1 || trimValue === 2 || trimValue === 3)  {
