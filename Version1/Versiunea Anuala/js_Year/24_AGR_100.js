            ...
            function toggleCap12(trimValue) {
                ...
                if (trimValue == 4) {
                    ...
                    if (headerElement.length) {
                        headerElement.hide();  // Ascunde elementul cu display: none
                        headerElement.css('display', 'none !important'); // Forțăm ascunderea dacă există stiluri care o suprascriu
                    }
                    ...
                    // Afișează capitolul 1.2 și rândurile aferente
